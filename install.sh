#!/bin/sh
# install.sh — install the ga4 CLI on macOS or Linux.
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/KLIXPERT-io/ga4-cli/refs/heads/main/install.sh | sh
#
# Env vars:
#   GA4_VERSION   pin a release tag (e.g. v1.2.3); default: latest
...
Environment variables:
  GA4_VERSION   release tag to install (default: latest)
...
tmp="$(mktemp -d 2>/dev/null || mktemp -d -t ga4-install)"

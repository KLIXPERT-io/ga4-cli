# install.ps1 — install the ga4 CLI on Windows (PowerShell 5.1+).
#
# Usage:
#   irm https://raw.githubusercontent.com/KLIXPERT-io/ga4-cli/refs/heads/main/install.ps1 | iex
#
# Env vars:
#   $env:GA4_VERSION   pin a release tag (e.g. v1.2.3); default: latest
#   $env:INSTALL_DIR   target directory; default: $env:LOCALAPPDATA\Programs\ga4

$ErrorActionPreference = 'Stop'

$Repo = 'KLIXPERT-io/ga4-cli'
$Bin  = 'ga4'

# --- resolve version ---
$version = $env:GA4_VERSION
if (-not $version) {
...
if (-not $targetDir) {
    $targetDir = Join-Path $env:LOCALAPPDATA "Programs\ga4"
}
New-Item -ItemType Directory -Force -Path $targetDir | Out-Null

# --- download + verify + extract ---
$tmp = Join-Path ([System.IO.Path]::GetTempPath()) ("ga4-install-" + [Guid]::NewGuid().ToString('N'))

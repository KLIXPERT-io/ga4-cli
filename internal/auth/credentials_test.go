...
func serviceAccountFixture(t *testing.T) string {
  ...
  "client_email": "ga4-reader@data-265420.iam.gserviceaccount.com",
  "client_id": "999",
...
func TestResolveServiceAccount(t *testing.T) {
	...
	if creds.JWT.Email != "ga4-reader@data-265420.iam.gserviceaccount.com" {
	...
	want := "sa:ga4-reader@data-265420.iam.gserviceaccount.com#user@example.com"

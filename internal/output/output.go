// Package output handles JSON / CSV / table rendering.
package output
...
type Meta struct {
	...
	// Partial marks a result the API flagged as sampled, thresholded, or
	// otherwise not a complete answer to the question that was asked.
	Partial bool `json:"partial,omitempty"`
	// RowCount is the total matching rows the API reported, which can exceed
	// the number of rows returned when a limit is in play.
